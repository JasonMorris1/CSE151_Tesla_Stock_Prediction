...
# Works Cited 
1: [History of the Stock Market](https://www.sofi.com/learn/content/history-of-the-stock-market/#:~:text=Who%20Created%20the%20Stock%20Market,Amsterdam%20stock%20exchange%20was%20created) (website)
...
Vandita Jain: 
I helped with selecting the dataset. Alongside, I attended all of the meetings and provided my insights on the work we together did as a team on zoom like the data preprocessing, data exploration, logistic regression and linear regresssion. I also helped in writing the Introduction and Conclusion. In addition, I also regularly interacted with the  professor and the teaching staff to get their valuable opinions.
